...
import com.example.nuovagames.HomeFragmentDirections;
        ...
        newsRecyclerViewAdapter = new NewsRecyclerViewAdapter(newsList,
                ...
                new NewsRecyclerViewAdapter.OnItemClickListener() {
                    ...
                    public void onNewsItemClick(Games news) {
                        HomeFragmentDirections.ActionFragmentHomeToDettaglioActivity action = HomeFragmentDirections.actionFragmentHomeToDettaglioActivity(news);
